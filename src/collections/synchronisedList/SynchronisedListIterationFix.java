 ...
 *       1) The list being synchronized only means that add, remove etc. operations are synchronized and therefore atomic.
 *          Iteration however is not and if a thread adds while another is iterating, you could get a ConcurrentModificationException.
 *       2) To avoid such situation we should iterate the Collections.synchronisedList in a synchronised context
 */
public class SynchronisedListIterationFix {
